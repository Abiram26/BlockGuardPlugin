				...
				if (x1 != x2) {
					...
					if (y1 != y2) {
						...
						if (z1 != z2) {
							...
							pl.sendMessage(ChatColor.WHITE
									+ "Flags: ["  +
									"can_player_break_block flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_break_block()+
			 " can_player_place_block flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_place_block()+
			 " can_player_interact_bed flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_bed()+
			 " can_player_interact_electronic flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_electronic()+
			 " can_player_interact_chest flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_chest()+
			 " can_player_interact_tnt flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_TNT()+
			 " can_player_interact_trashcan flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_trashcan()+
			 " can_player_interact_paintbucket flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_paintbucket()+
			 " can_player_interact_canvas flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_canvas()+
			 " can_player_interact_elevator flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_elevator()+
			 " can_player_open_chest flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_open_chest()+
			 " can_player_execute_command flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_execute_command()+
			 " can_player_attack_player flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_attack_player()+
			 " can_player_attack_npc flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_attack_NPC()+
			 " can_player_pickup_item flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_pickup_item()+
			 " can_player_drop_item flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_drop_item()+
			 " can_player_die flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_die()+
			 " can_player_heal flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_heal()+
			 " can_player_receive_damage flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_receive_damage()+
			 " can_player_teleport flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_teleport()+
			 " can_player_chat_public flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_chat_public()+
			 " can_player_chat flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_chat()+
			 " can_player_wield flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_wield()+
			 " can_player_unwield flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_unwield()+
			 " can_player_setspawn flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_setspawn()+
			 " can_player_text_sign flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_text_sign()+
			 " can_npc_move flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_move()+
			 " can_npc_attack_player flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_attack_player()+
			 " can_npc_attack_npc flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_attack_NPC()+
			 " can_npc_die flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_die()+
			 " can_npc_heal flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_heal()+
			 " can_npc_receive_damage flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_receive_damage()+
			 " can_npc_spawn flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_spawn()+
			 " can_npc_interact flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_NPC_interact()+
			 " can_grass_grow flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_grass_grow()+
			 " can_plant_grow flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_plant_grow()+
			 " can_tree_grow flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_tree_grow()+
			 " can_tnt_explode flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_TNT_explode()+
			 " can_block_gravitate flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_block_gravitate()+
			 " can_block_decay flag:" + 
				 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_block_decay()+
			 " can_player_place_block flag:" + 
					 cfg4.getFlags().get(cfg4.getFlags().size()-1).isCan_player_interact_door());
						} else {
