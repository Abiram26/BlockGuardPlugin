		...
		if (sender instanceof Player) {
			...
			if (sender.hasPermission("abiram26.blockguard.*")) {
				...
				if (label.equalsIgnoreCase("bgpos1")
					...
					sender.sendMessage(BlockGuardPlugin.stamp + "Position 1 set! ["
							+ posX + "," + posY + "," + posZ + "]");
				} else {
					...
					sender.sendMessage(BlockGuardPlugin.stamp + "Position 2 set! ["
							+ posX + "," + posY + "," + posZ + "]");
				}
				this.makeBorder(player);
			} else {
				sender.sendMessage(BlockGuardPlugin.stamp + "No permission!");
			}
		} else {
